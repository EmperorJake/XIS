...
industry.economy_variations['FIRS'].name = 'string(STR_IND_BLAST_FURNACE)'
industry.economy_variations['FIRS'].processed_cargos_and_output_ratios = [('IORE', 3), ('COKE', 3), ('LIME', 2)]
industry.economy_variations['FIRS'].prod_cargo_types = [('IRON', 6), ('SLAG', 2)]
