...
industry = IndustryTertiary(id='hotel',
                            accept_cargo_types=['FOOD', 'PASS', 'BEER'],
...
sprite_ground = industry.add_sprite(
    sprite_number='GROUNDSPRITE_CONCRETE'
)
spriteset_ground_overlay = industry.add_spriteset(
    type='empty',
)
sprite_building_1 = industry.add_sprite(
    sprite_number='(terrain_type == TILETYPE_SNOW) ? 1450 : 1450'
)
sprite_building_2 = industry.add_sprite(
    sprite_number='(terrain_type == TILETYPE_SNOW) ? 1453 : 1453'
)
