...
_static_140383634710368 = 'load: properties_industry.pynml'
_static_140383636558792 = "location_checks_industry.macros['render_tree']"
_static_140383636560360 = 'load: availability.pynml'
_static_140383636559296 = 'load: layouts.pynml'
_static_140383635308328 = 'load: properties_tile.pynml'
_static_140383635191176 = "animation_macros.macros['tile_animation']"
_static_140383635191344 = "location_checks_tile.macros['render_tree']"
_static_140383635191008 = 'load: graphics_switches.pynml'
_static_140383635191400 = 'load: spritelayouts.pynml'
_static_140383637224528 = 'load: spritesets.pynml'
...
def initialize(__loader, macros, nothing, template):
    ...
    def render(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            __append('\n\n')
            __backup_location_checks_tile_140383635887664 = get('location_checks_tile', __marker)
            ...
            if (__backup_location_checks_tile_140383635887664 is __marker):
                ...
                econtext['location_checks_tile'] = __backup_location_checks_tile_140383635887664
            __append('\n\n')
            __backup_animation_macros_140383635886992 = get('animation_macros', __marker)
            ...
            if (__backup_animation_macros_140383635886992 is __marker):
                ...
                econtext['animation_macros'] = __backup_animation_macros_140383635886992
            __append('\n\n')
            ...
            __append('\n\n')
            __backup_location_checks_industry_140383635889344 = get('location_checks_industry', __marker)
            ...
            if (__backup_location_checks_industry_140383635889344 is __marker):
                ...
                econtext['location_checks_industry'] = __backup_location_checks_industry_140383635889344
            __append('\n\n')
            ...
            __token = 1446
            __content_140383655711776_1444 = _lookup_attr(getitem('industry'), 'numeric_id')
            __content_140383655711776_1444 = __quote(__content_140383655711776_1444, '\x00', '&#0;', None, False)
            __token = 1511
            __content_140383655711776_1509 = _lookup_attr(getitem('industry'), 'id')
            __content_140383655711776_1509 = __quote(__content_140383655711776_1509, '\x00', '&#0;', None, False)
            __token = 1645
            __content_140383655711776_1643 = _lookup_attr(getitem('industry'), 'id')
            __content_140383655711776_1643 = __quote(__content_140383655711776_1643, '\x00', '&#0;', None, False)
            __content_140383655711776 = ('%s%s%s%s%s%s%s%s%s' % ('\nitem(FEAT_INDUSTRIES, ', (__content_140383655711776 if (__content_140383655711776 is not None) else ''), ', ', (__content_140383655711776_1444 if (__content_140383655711776_1444 is not None) else ''), ') {\n\tgraphics {\n\t\tconstruction_probability:', (__content_140383655711776_1509 if (__content_140383655711776_1509 is not None) else ''), '_check_availability;\n        build_prod_change:       randomise_primary_production_on_build;\n\t\tlocation_check:          ', (__content_140383655711776_1643 if (__content_140383655711776_1643 is not None) else ''), '_check_location;\n\t\tmonthly_prod_change:     return CB_RESULT_IND_PROD_NO_CHANGE;\n\t\trandom_prod_change:      return CB_RESULT_IND_PROD_NO_CHANGE;\n//\t\textra_text_industry:     // no extra text. No production increase by means of FMSP\n\t\tcolour:                  switch_colour;\n\t}\n}\n', ))
