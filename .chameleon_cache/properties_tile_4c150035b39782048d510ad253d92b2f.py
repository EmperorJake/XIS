...
def initialize(__loader, macros, nothing, template):
    ...
    def render(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            get = econtext.get
            __backup_tile_140166499154744 = get('tile', __marker)

            # <Value 'industry.tiles' (1:24)> -> __iterator
            __token = 24
            __iterator = _lookup_attr(getitem('industry'), 'tiles')
            (__iterator, ____index_140166499482424, ) = getitem('repeat')('tile', __iterator)
            econtext['tile'] = None
            for __item in __iterator:
                econtext['tile'] = __item
                __append('\n    ')

                # <Interpolation value=<Substitution '\n    item(FEAT_INDUSTRYTILES, ${tile.id}, ${tile.numeric_id}) {\n        property {\n            substitute:         0;\n            land_shape_flags:   ${tile.land_shape_flags};\n            ' (2:61)> braces_required=True translation=False at 7f7b0e693278> -> __content_140166518101192
                __token = 107
                __token = 134
                ...
                __token = 146
                __content_140166518101192_144 = _lookup_attr(getitem('tile'), 'numeric_id')
                __content_140166518101192_144 = __quote(__content_140166518101192_144, '\x00', '&#0;', None, False)
                __token = 254
                __content_140166518101192_252 = _lookup_attr(getitem('tile'), 'land_shape_flags')
                __content_140166518101192_252 = __quote(__content_140166518101192_252, '\x00', '&#0;', None, False)
                __content_140166518101192 = ('%s%s%s%s%s%s%s' % ('\n    item(FEAT_INDUSTRYTILES, ', (__content_140166518101192 if (__content_140166518101192 is not None) else ''), ', ', (__content_140166518101192_144 if (__content_140166518101192_144 is not None) else ''), ') {\n        property {\n            substitute:         0;\n            land_shape_flags:   ', (__content_140166518101192_252 if (__content_140166518101192_252 is not None) else ''), ';\n            ', ))
                ...
                if __condition:
                    ...
                    # <Interpolation value=<Substitution '\n                special_flags: ${tile.special_flags};\n            ' (7:74)> braces_required=True translation=False at 7f7b0e693780> -> __content_140166518101192
                    __token = 369
                    __token = 386
                    __content_140166518101192 = _lookup_attr(getitem('tile'), 'special_flags')
                    __content_140166518101192 = __quote(__content_140166518101192, '\x00', '&#0;', None, False)
                    __content_140166518101192 = ('%s%s%s' % ('\n                special_flags: ', (__content_140166518101192 if (__content_140166518101192 is not None) else ''), ';\n            ', ))
                    if (__content_140166518101192 is None):
                        pass
                    else:
                        if (__content_140166518101192 is False):
                ...
                if __condition:
                    ...
                    # <Interpolation value=<Substitution "\n                animation_info: [${'ANIMATION_LOOPING' if tile.animation_looping else 'ANIMATION_NON_LOOPING'}, ${tile.animation_length}];\n            " (11:70)> braces_required=True translation=False at 7f7b0e693320> -> __content_140166518101192
                    __token = 624
                    __token = 643
                    __content_140166518101192 = ('ANIMATION_LOOPING' if _lookup_attr(getitem('tile'), 'animation_looping') else 'ANIMATION_NON_LOOPING')
                    __content_140166518101192 = __quote(__content_140166518101192, '\x00', '&#0;', None, False)
                    __token = 722
                    __content_140166518101192_720 = _lookup_attr(getitem('tile'), 'animation_length')
                    __content_140166518101192_720 = __quote(__content_140166518101192_720, '\x00', '&#0;', None, False)
                    __content_140166518101192 = ('%s%s%s%s%s' % ('\n                animation_info: [', (__content_140166518101192 if (__content_140166518101192 is not None) else ''), ', ', (__content_140166518101192_720 if (__content_140166518101192_720 is not None) else ''), '];\n            ', ))
                    if (__content_140166518101192 is None):
                        pass
                    else:
                        if (__content_140166518101192 is False):
                ...
                if __condition:
                    ...
                    # <Interpolation value=<Substitution '\n                animation_speed: ${tile.animation_speed};\n            ' (14:70)> braces_required=True translation=False at 7f7b0e693e10> -> __content_140166518101192
                    __token = 868
                    __token = 887
                    __content_140166518101192 = _lookup_attr(getitem('tile'), 'animation_speed')
                    __content_140166518101192 = __quote(__content_140166518101192, '\x00', '&#0;', None, False)
                    __content_140166518101192 = ('%s%s%s' % ('\n                animation_speed: ', (__content_140166518101192 if (__content_140166518101192 is not None) else ''), ';\n            ', ))
                    if (__content_140166518101192 is None):
                        pass
                    else:
                        if (__content_140166518101192 is False):
                ...
                # <Interpolation value=<Substitution '\n            animation_triggers: ${tile.get_animation_triggers()};\n        }\n\n        graphics {\n    \t\t' (16:34)> braces_required=True translation=False at 7f7b0e693cf8> -> __content_140166518101192
                __token = 957
                __token = 979
                __content_140166518101192 = _lookup_attr(getitem('tile'), 'get_animation_triggers')()
                __content_140166518101192 = __quote(__content_140166518101192, '\x00', '&#0;', None, False)
                __content_140166518101192 = ('%s%s%s' % ('\n            animation_triggers: ', (__content_140166518101192 if (__content_140166518101192 is not None) else ''), ';\n        }\n\n        graphics {\n    \t\t', ))
                if (__content_140166518101192 is None):
                    pass
                else:
                    if (__content_140166518101192 is False):
                ...
                if __condition:
                    ...
                    # <Interpolation value=<Substitution '\n    \t\t    tile_check: ${tile.location_checks.get_render_tree(tile.id, industry.id)[-1].switch_entry_point};\n            ' (21:111)> braces_required=True translation=False at 7f7b0e693f98> -> __content_140166518101192
                    __token = 1163
                    __token = 1177
                    __content_140166518101192 = _lookup_attr(_lookup_attr(_lookup_attr(getitem('tile'), 'location_checks'), 'get_render_tree')(_lookup_attr(getitem('tile'), 'id'), _lookup_attr(getitem('industry'), 'id'))[- 1], 'switch_entry_point')
                    __content_140166518101192 = __quote(__content_140166518101192, '\x00', '&#0;', None, False)
                    __content_140166518101192 = ('%s%s%s' % ('\n    \t\t    tile_check: ', (__content_140166518101192 if (__content_140166518101192 is not None) else ''), ';\n            ', ))
                    if (__content_140166518101192 is None):
                        pass
                    else:
                        if (__content_140166518101192 is False):
                ...
                if __condition:
                    ...
                    # <Interpolation value=<Substitution '\n                anim_next_frame: return ${tile.custom_animation_next_frame};\n            ' (24:78)> braces_required=True translation=False at 7f7b0e6932b0> -> __content_140166518101192
                    __token = 1395
                    __token = 1421
                    __content_140166518101192 = _lookup_attr(getitem('tile'), 'custom_animation_next_frame')
                    __content_140166518101192 = __quote(__content_140166518101192, '\x00', '&#0;', None, False)
                    __content_140166518101192 = ('%s%s%s' % ('\n                anim_next_frame: return ', (__content_140166518101192 if (__content_140166518101192 is not None) else ''), ';\n            ', ))
                    if (__content_140166518101192 is None):
                        pass
                    else:
                        if (__content_140166518101192 is False):
                ...
                if __condition:
                    ...
                    # <Interpolation value=<Substitution '\n    \t\t    anim_control: ${tile.id}_anim_control;\n    \t\t' (27:78)> braces_required=True translation=False at 7f7b0e693198> -> __content_140166518101192
                    __token = 1580
                    __token = 1596
                    __content_140166518101192 = _lookup_attr(getitem('tile'), 'id')
                    __content_140166518101192 = __quote(__content_140166518101192, '\x00', '&#0;', None, False)
                    __content_140166518101192 = ('%s%s%s' % ('\n    \t\t    anim_control: ', (__content_140166518101192 if (__content_140166518101192 is not None) else ''), '_anim_control;\n    \t\t', ))
                    if (__content_140166518101192 is None):
                        pass
                    else:
                        if (__content_140166518101192 is False):
                ...
                if __condition:
                    ...
                    # <Interpolation value=<Substitution '\n                random_trigger: ${tile.random_trigger};\n            ' (30:76)> braces_required=True translation=False at 7f7b0e693cc0> -> __content_140166518101192
                    __token = 1738
                    __token = 1756
                    __content_140166518101192 = _lookup_attr(getitem('tile'), 'random_trigger')
                    __content_140166518101192 = __quote(__content_140166518101192, '\x00', '&#0;', None, False)
                    __content_140166518101192 = ('%s%s%s' % ('\n                random_trigger: ', (__content_140166518101192 if (__content_140166518101192 is not None) else ''), ';\n            ', ))
                    if (__content_140166518101192 is None):
                        pass
                    else:
                        if (__content_140166518101192 is False):
                ...
                if __condition:
                    ...
                    # <Interpolation value=<Substitution '\n                foundations: ${tile.foundations};\n            ' (33:64)> braces_required=True translation=False at 7f7b0e693eb8> -> __content_140166518101192
                    __token = 1893
                    __token = 1908
                    __content_140166518101192 = _lookup_attr(getitem('tile'), 'foundations')
                    __content_140166518101192 = __quote(__content_140166518101192, '\x00', '&#0;', None, False)
                    __content_140166518101192 = ('%s%s%s' % ('\n                foundations: ', (__content_140166518101192 if (__content_140166518101192 is not None) else ''), ';\n            ', ))
                    if (__content_140166518101192 is None):
                        pass
                    else:
                        if (__content_140166518101192 is False):
                ...
                if __condition:
                    ...
                    # <Interpolation value=<Substitution '\n                autoslope: ${tile.autoslope};\n            ' (36:60)> braces_required=True translation=False at 7f7b0e693588> -> __content_140166518101192
                    __token = 2035
                    __token = 2048
                    __content_140166518101192 = _lookup_attr(getitem('tile'), 'autoslope')
                    __content_140166518101192 = __quote(__content_140166518101192, '\x00', '&#0;', None, False)
                    __content_140166518101192 = ('%s%s%s' % ('\n                autoslope: ', (__content_140166518101192 if (__content_140166518101192 is not None) else ''), ';\n            ', ))
                    if (__content_140166518101192 is None):
                        pass
                    else:
                        if (__content_140166518101192 is False):
                ...
                # <Interpolation value=<Substitution '\n            ${industry.id}_tile_fences;\n        }\n    }\n    ' (38:28)> braces_required=True translation=False at 7f7b0e6930f0> -> __content_140166518101192
                __token = 2106
                __token = 2108
                __content_140166518101192 = _lookup_attr(getitem('industry'), 'id')
                __content_140166518101192 = __quote(__content_140166518101192, '\x00', '&#0;', None, False)
                __content_140166518101192 = ('%s%s%s' % ('\n            ', (__content_140166518101192 if (__content_140166518101192 is not None) else ''), '_tile_fences;\n        }\n    }\n    ', ))
                if (__content_140166518101192 is None):
                    pass
                else:
                    if (__content_140166518101192 is False):
                ...
                if (__content_140166518101192 is not None):
                    __append(__content_140166518101192)
                __append('\n    ')
                __backup_economy_140166499562944 = get('economy', __marker)

                # <Value 'economies' (45:35)> -> __iterator
                __token = 2251
                __iterator = getitem('economies')
                (__iterator, ____index_140166499218824, ) = getitem('repeat')('economy', __iterator)
                econtext['economy'] = None
                for __item in __iterator:
                    econtext['economy'] = __item

                    # <Interpolation value=<Substitution '\n        if (economy==${economy.numeric_id}) {\n            ' (45:46)> braces_required=True translation=False at 7f7b0e653320> -> __content_140166518101192
                    __token = 2271
                    __token = 2286
                    ...
                    if __condition:
                        ...
                        # <Interpolation value=<Substitution '\n                item(FEAT_INDUSTRYTILES, ${tile.id}, ${tile.numeric_id}) {\n                    property {\n                        accepted_cargos:  [${tile.get_expression_for_tile_acceptance(industry, economy)}];\n                    }\n                }\n            ' (47:98)> braces_required=True translation=False at 7f7b0e6536d8> -> __content_140166518101192
                        __token = 2424
                        __token = 2451
                        __content_140166518101192 = _lookup_attr(getitem('tile'), 'id')
                        __content_140166518101192 = __quote(__content_140166518101192, '\x00', '&#0;', None, False)
                        __token = 2463
                        __content_140166518101192_2461 = _lookup_attr(getitem('tile'), 'numeric_id')
                        __content_140166518101192_2461 = __quote(__content_140166518101192_2461, '\x00', '&#0;', None, False)
                        __token = 2559
                        __content_140166518101192_2557 = _lookup_attr(getitem('tile'), 'get_expression_for_tile_acceptance')(getitem('industry'), getitem('economy'))
                        __content_140166518101192_2557 = __quote(__content_140166518101192_2557, '\x00', '&#0;', None, False)
                        __content_140166518101192 = ('%s%s%s%s%s%s%s' % ('\n                item(FEAT_INDUSTRYTILES, ', (__content_140166518101192 if (__content_140166518101192 is not None) else ''), ', ', (__content_140166518101192_2461 if (__content_140166518101192_2461 is not None) else ''), ') {\n                    property {\n                        accepted_cargos:  [', (__content_140166518101192_2557 if (__content_140166518101192_2557 is not None) else ''), '];\n                    }\n                }\n            ', ))
                        if (__content_140166518101192 is None):
                            pass
                        else:
                            if (__content_140166518101192 is False):
                        ...
                        if (__content_140166518101192 is not None):
                            __append(__content_140166518101192)
                    __append('\n        }\n    ')
                    ____index_140166499218824 -= 1
                    if (____index_140166499218824 > 0):
                        __append('')
                if (__backup_economy_140166499562944 is __marker):
                    del econtext['economy']
                else:
                    econtext['economy'] = __backup_economy_140166499562944
                __append('\n')
                ____index_140166499482424 -= 1
                if (____index_140166499482424 > 0):
                    __append('')
            if (__backup_tile_140166499154744 is __marker):
                del econtext['tile']
            else:
                econtext['tile'] = __backup_tile_140166499154744
            __append('\n')
        except:
