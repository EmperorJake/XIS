# -*- coding: utf-8 -*-
__filename = '/home/jake/GRF/firs-3.0.10-source/bundle_dir/src/src/templates/parameters.pynml'
...
def initialize(__loader, macros, nothing, template):
    ...
    def render(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            (__iterator, ____index_140183231303632, ) = getitem('repeat')('economy', __iterator)
            ...
            for __item in __iterator:
                ...
                __token = 1340
                __content_140183249773656_1338 = _lookup_attr(getitem('economy'), 'numeric_id')
                __content_140183249773656_1338 = __quote(__content_140183249773656_1338, '\x00', '&#0;', None, False)
                __content_140183249773656 = ('%s%s%s%s%s' % ('\n    if (economy_selection == ', (__content_140183249773656 if (__content_140183249773656 is not None) else ''), ') {\n        economy = ', (__content_140183249773656_1338 if (__content_140183249773656_1338 is not None) else ''), ';\n    }\n', ))
