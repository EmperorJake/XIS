...
def initialize(__loader, macros, nothing, template):
    ...
    def render(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            __backup_perm_storage_140383637160736 = get('perm_storage', __marker)
            ...
            # <Interpolation value=<Substitution '\n    switch(FEAT_INDUSTRIES, SELF, ${industry.id}_monthly_update, [\n        STORE_PERM(LOAD_PERM(${perm_storage.var_num_supplies_delivered_last}), ${perm_storage.var_num_supplies_delivered_bef_last}),\n        STORE_PERM(LOAD_PERM(${perm_storage.var_num_supplies_delivered}), ${perm_storage.var_num_supplies_delivered_last}),\n        STORE_PERM(0, ${perm_storage.var_num_supplies_delivered})\n    ]) {\n        return CB_RESULT_IND_PROD_NO_CHANGE;\n    }\n' (6:55)> braces_required=True translation=False at 7fad9cc5a470> -> __content_140383655711776
            __token = 273
            __token = 305
            ...
            __token = 367
            __content_140383655711776_365 = _lookup_attr(getitem('perm_storage'), 'var_num_supplies_delivered_last')
            __content_140383655711776_365 = __quote(__content_140383655711776_365, '\x00', '&#0;', None, False)
            __token = 417
            __content_140383655711776_415 = _lookup_attr(getitem('perm_storage'), 'var_num_supplies_delivered_bef_last')
            __content_140383655711776_415 = __quote(__content_140383655711776_415, '\x00', '&#0;', None, False)
            __token = 500
            __content_140383655711776_498 = _lookup_attr(getitem('perm_storage'), 'var_num_supplies_delivered')
            __content_140383655711776_498 = __quote(__content_140383655711776_498, '\x00', '&#0;', None, False)
            __token = 545
            __content_140383655711776_543 = _lookup_attr(getitem('perm_storage'), 'var_num_supplies_delivered_last')
            __content_140383655711776_543 = __quote(__content_140383655711776_543, '\x00', '&#0;', None, False)
            __token = 617
            __content_140383655711776_615 = _lookup_attr(getitem('perm_storage'), 'var_num_supplies_delivered')
            __content_140383655711776_615 = __quote(__content_140383655711776_615, '\x00', '&#0;', None, False)
            __content_140383655711776 = ('%s%s%s%s%s%s%s%s%s%s%s%s%s' % ('\n    switch(FEAT_INDUSTRIES, SELF, ', (__content_140383655711776 if (__content_140383655711776 is not None) else ''), '_monthly_update, [\n        STORE_PERM(LOAD_PERM(', (__content_140383655711776_365 if (__content_140383655711776_365 is not None) else ''), '), ', (__content_140383655711776_415 if (__content_140383655711776_415 is not None) else ''), '),\n        STORE_PERM(LOAD_PERM(', (__content_140383655711776_498 if (__content_140383655711776_498 is not None) else ''), '), ', (__content_140383655711776_543 if (__content_140383655711776_543 is not None) else ''), '),\n        STORE_PERM(0, ', (__content_140383655711776_615 if (__content_140383655711776_615 is not None) else ''), ')\n    ]) {\n        return CB_RESULT_IND_PROD_NO_CHANGE;\n    }\n', ))
            ...
            if (__backup_perm_storage_140383637160736 is __marker):
                del econtext['perm_storage']
            else:
                econtext['perm_storage'] = __backup_perm_storage_140383637160736
            __append('\n')
        except:
