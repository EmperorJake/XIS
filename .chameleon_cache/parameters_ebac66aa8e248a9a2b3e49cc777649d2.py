# -*- coding: utf-8 -*-
__filename = '/home/jake/GRF/XIS/src/templates/parameters.pynml'
...
def initialize(__loader, macros, nothing, template):
    ...
    def render(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            __backup_economy_139875139823208 = get('economy', __marker)

            # <Value 'economies' (21:35)> -> __iterator
            __token = 1252
            __iterator = getitem('economies')
            (__iterator, ____index_139875070932304, ) = getitem('repeat')('economy', __iterator)
            econtext['economy'] = None
            for __item in __iterator:
                econtext['economy'] = __item

                # <Interpolation value=<Substitution '\n    if (economy_selection == ${repeat.economy.index}) {\n        economy = ${economy.numeric_id};\n    }\n' (21:46)> braces_required=True translation=False at 7f3733ea7c88> -> __content_139875089167952
                __token = 1268
                __token = 1295
                ...
                __token = 1340
                __content_139875089167952_1338 = _lookup_attr(getitem('economy'), 'numeric_id')
                __content_139875089167952_1338 = __quote(__content_139875089167952_1338, '\x00', '&#0;', None, False)
                __content_139875089167952 = ('%s%s%s%s%s' % ('\n    if (economy_selection == ', (__content_139875089167952 if (__content_139875089167952 is not None) else ''), ') {\n        economy = ', (__content_139875089167952_1338 if (__content_139875089167952_1338 is not None) else ''), ';\n    }\n', ))
                ...
                ____index_139875070932304 -= 1
                if (____index_139875070932304 > 0):
                    __append('')
            if (__backup_economy_139875139823208 is __marker):
                del econtext['economy']
            else:
                econtext['economy'] = __backup_economy_139875139823208
