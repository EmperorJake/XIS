...
def initialize(__loader, macros, nothing, template):
    ...
    def render(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            get = econtext.get
            __append('\n\n')
            __backup_industry_layout_139703104062520 = get('industry_layout', __marker)

            # <Value 'python:industry.industry_layouts' (8:64)> -> __iterator
            __token = 658
            __iterator = _lookup_attr(getitem('industry'), 'industry_layouts')
            (__iterator, ____index_139703106016816, ) = getitem('repeat')('industry_layout', __iterator)
            ...
            for __item in __iterator:
                ...
                __content_139703124559104 = ('%s%s%s' % ('\n    tilelayout ', (__content_139703124559104 if (__content_139703124559104 is not None) else ''), '_tilelayout {\n        ', ))
                ...
                (__iterator, ____index_139703106019168, ) = getitem('repeat')('layout', __iterator)
                ...
                for __item in __iterator:
                    ...
                    __content_139703124559104_844 = __quote(__content_139703124559104_844, '\x00', '&#0;', None, False)
                    __token = 860
                    __content_139703124559104_858 = getitem('layout')[2]
                    __content_139703124559104_858 = __quote(__content_139703124559104_858, '\x00', '&#0;', None, False)
                    __content_139703124559104 = ('%s%s%s%s%s%s%s' % ('\n            ', (__content_139703124559104 if (__content_139703124559104 is not None) else ''), ', ', (__content_139703124559104_844 if (__content_139703124559104_844 is not None) else ''), ': ', (__content_139703124559104_858 if (__content_139703124559104_858 is not None) else ''), ';\n        ', ))
                    if (__content_139703124559104 is None):
                        pass
                    else:
                        if (__content_139703124559104 is False):
            ...
            if (__backup_industry_layout_139703104062520 is __marker):
                ...
                econtext['industry_layout'] = __backup_industry_layout_139703104062520
            __append('\n')
        except:
