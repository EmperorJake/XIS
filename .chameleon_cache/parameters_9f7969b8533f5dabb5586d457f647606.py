...
def initialize(__loader, macros, nothing, template):
    ...
    def render(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            __backup_economy_140302390788048 = get('economy', __marker)

            # <Value 'economies' (21:35)> -> __iterator
            __token = 1252
            __iterator = getitem('economies')
            (__iterator, ____index_140302364740912, ) = getitem('repeat')('economy', __iterator)
            econtext['economy'] = None
            for __item in __iterator:
                econtext['economy'] = __item

                # <Interpolation value=<Substitution '\n    if (economy_selection == ${repeat.economy.index}) {\n        economy = ${economy.numeric_id};\n    }\n' (21:46)> braces_required=True translation=False at 7f9ab09c8ef0> -> __content_140302383355024
                __token = 1268
                __token = 1295
                ...
                __token = 1340
                __content_140302383355024_1338 = _lookup_attr(getitem('economy'), 'numeric_id')
                __content_140302383355024_1338 = __quote(__content_140302383355024_1338, '\x00', '&#0;', None, False)
                __content_140302383355024 = ('%s%s%s%s%s' % ('\n    if (economy_selection == ', (__content_140302383355024 if (__content_140302383355024 is not None) else ''), ') {\n        economy = ', (__content_140302383355024_1338 if (__content_140302383355024_1338 is not None) else ''), ';\n    }\n', ))
                ...
                ____index_140302364740912 -= 1
                if (____index_140302364740912 > 0):
                    __append('')
            if (__backup_economy_140302390788048 is __marker):
                del econtext['economy']
            else:
                econtext['economy'] = __backup_economy_140302390788048
