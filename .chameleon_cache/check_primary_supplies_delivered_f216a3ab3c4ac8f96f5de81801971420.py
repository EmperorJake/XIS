...
def initialize(__loader, macros, nothing, template):
    ...
    def render(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            __backup_perm_storage_139703105753664 = get('perm_storage', __marker)
            ...
            __token = 367
            __content_139703124559104_365 = _lookup_attr(getitem('perm_storage'), 'var_num_supplies_delivered_last')
            __content_139703124559104_365 = __quote(__content_139703124559104_365, '\x00', '&#0;', None, False)
            __token = 417
            __content_139703124559104_415 = _lookup_attr(getitem('perm_storage'), 'var_num_supplies_delivered_bef_last')
            __content_139703124559104_415 = __quote(__content_139703124559104_415, '\x00', '&#0;', None, False)
            __token = 500
            __content_139703124559104_498 = _lookup_attr(getitem('perm_storage'), 'var_num_supplies_delivered')
            __content_139703124559104_498 = __quote(__content_139703124559104_498, '\x00', '&#0;', None, False)
            __token = 545
            __content_139703124559104_543 = _lookup_attr(getitem('perm_storage'), 'var_num_supplies_delivered_last')
            __content_139703124559104_543 = __quote(__content_139703124559104_543, '\x00', '&#0;', None, False)
            __token = 617
            __content_139703124559104_615 = _lookup_attr(getitem('perm_storage'), 'var_num_supplies_delivered')
            __content_139703124559104_615 = __quote(__content_139703124559104_615, '\x00', '&#0;', None, False)
            __content_139703124559104 = ('%s%s%s%s%s%s%s%s%s%s%s%s%s' % ('\n    switch(FEAT_INDUSTRIES, SELF, ', (__content_139703124559104 if (__content_139703124559104 is not None) else ''), '_monthly_update, [\n        STORE_PERM(LOAD_PERM(', (__content_139703124559104_365 if (__content_139703124559104_365 is not None) else ''), '), ', (__content_139703124559104_415 if (__content_139703124559104_415 is not None) else ''), '),\n        STORE_PERM(LOAD_PERM(', (__content_139703124559104_498 if (__content_139703124559104_498 is not None) else ''), '), ', (__content_139703124559104_543 if (__content_139703124559104_543 is not None) else ''), '),\n        STORE_PERM(0, ', (__content_139703124559104_615 if (__content_139703124559104_615 is not None) else ''), ')\n    ]) {\n        return CB_RESULT_IND_PROD_NO_CHANGE;\n    }\n', ))
            ...
            if (__backup_perm_storage_139703105753664 is __marker):
                ...
                econtext['perm_storage'] = __backup_perm_storage_139703105753664
            __append('\n')
        except:
