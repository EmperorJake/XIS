...
_static_140302364777216 = 'location_check.macro'
...
def initialize(__loader, macros, nothing, template):
    ...
    def render_render_tree(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            get = econtext.get
            __append('\n    ')
            __backup_tile_140302364493136 = get('tile', __marker)

            # <Value 'industry.tiles' (9:43)> -> __iterator
            __token = 389
            __iterator = _lookup_attr(getitem('industry'), 'tiles')
            (__iterator, ____index_140302364778392, ) = getitem('repeat')('tile', __iterator)
            econtext['tile'] = None
            for __item in __iterator:
                econtext['tile'] = __item
                __append('\n        ')
                __backup_location_checks_140302390820368 = get('location_checks', __marker)
                ...
                __backup_location_check_140302364495544 = get('location_check', __marker)

                # <Value 'location_checks' (10:125)> -> __iterator
                __token = 531
                __iterator = getitem('location_checks')
                (__iterator, ____index_140302364776880, ) = getitem('repeat')('location_check', __iterator)
                econtext['location_check'] = None
                for __item in __iterator:
                    econtext['location_check'] = __item
                    __append('\n            ')
                    __backup_macroname_140302363566216 = get('macroname', __marker)

                    # <Static value=<_ast.Str object at 0x7f9ab09d1b00> name=None at 7f9ab09d1fd0> -> __value
                    __value = _static_140302364777216
                    ...
                    if (__backup_macroname_140302363566216 is __marker):
                        del econtext['macroname']
                    else:
                        econtext['macroname'] = __backup_macroname_140302363566216
                    __append('\n        ')
                    ____index_140302364776880 -= 1
                    if (____index_140302364776880 > 0):
                        __append('')
                if (__backup_location_check_140302364495544 is __marker):
                    del econtext['location_check']
                else:
                    econtext['location_check'] = __backup_location_check_140302364495544
                if (__backup_location_checks_140302390820368 is __marker):
                    del econtext['location_checks']
                else:
                    econtext['location_checks'] = __backup_location_checks_140302390820368
                __append('\n    ')
                ____index_140302364778392 -= 1
                if (____index_140302364778392 > 0):
                    __append('')
            if (__backup_tile_140302364493136 is __marker):
                del econtext['tile']
            else:
                econtext['tile'] = __backup_tile_140302364493136
            __append('\n')
        except:
    ...
    def render_require_sea_tile(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            __token = 1139
            __content_140302383355024_1137 = _lookup_attr(getitem('location_check'), 'switch_result')
            __content_140302383355024_1137 = __quote(__content_140302383355024_1137, '\x00', '&#0;', None, False)
            __token = 1198
            __content_140302383355024_1196 = _lookup_attr(getitem('location_check'), 'switch_result')
            __content_140302383355024_1196 = __quote(__content_140302383355024_1196, '\x00', '&#0;', None, False)
            __content_140302383355024 = ('%s%s%s%s%s%s%s' % ('\n    switch(FEAT_INDUSTRYTILES, SELF, ', (__content_140302383355024 if (__content_140302383355024 is not None) else ''), ', nearby_tile_water_class(0,0)) {\n        WATER_CLASS_SEA: ', (__content_140302383355024_1137 if (__content_140302383355024_1137 is not None) else ''), ';\n        WATER_CLASS_NONE: ', (__content_140302383355024_1196 if (__content_140302383355024_1196 is not None) else ''), ';\n        return CB_RESULT_LOCATION_DISALLOW;\n    }\n', ))
    ...
    def render_require_height_range(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '\n    switch(FEAT_INDUSTRYTILES, SELF, ${location_check.switch_entry_point}, UCMP(nearby_tile_height(0, 0) - ${location_check.minh}, ${location_check.maxh} - ${location_check.minh})) {\n        0..1: ${location_check.switch_result};\n        ${location_check.outrange};\n    }\n' (32:114)> braces_required=True translation=False at 7f9ab09d1518> -> __content_140302383355024
            __token = 1631
            __token = 1666
            __content_140302383355024 = _lookup_attr(getitem('location_check'), 'switch_entry_point')
            __content_140302383355024 = __quote(__content_140302383355024, '\x00', '&#0;', None, False)
            __token = 1736
            __content_140302383355024_1734 = _lookup_attr(getitem('location_check'), 'minh')
            __content_140302383355024_1734 = __quote(__content_140302383355024_1734, '\x00', '&#0;', None, False)
            __token = 1760
            __content_140302383355024_1758 = _lookup_attr(getitem('location_check'), 'maxh')
            __content_140302383355024_1758 = __quote(__content_140302383355024_1758, '\x00', '&#0;', None, False)
            __token = 1785
            __content_140302383355024_1783 = _lookup_attr(getitem('location_check'), 'minh')
            __content_140302383355024_1783 = __quote(__content_140302383355024_1783, '\x00', '&#0;', None, False)
            __token = 1826
            __content_140302383355024_1824 = _lookup_attr(getitem('location_check'), 'switch_result')
            __content_140302383355024_1824 = __quote(__content_140302383355024_1824, '\x00', '&#0;', None, False)
            __token = 1867
            __content_140302383355024_1865 = _lookup_attr(getitem('location_check'), 'outrange')
            __content_140302383355024_1865 = __quote(__content_140302383355024_1865, '\x00', '&#0;', None, False)
            __content_140302383355024 = ('%s%s%s%s%s%s%s%s%s%s%s%s%s' % ('\n    switch(FEAT_INDUSTRYTILES, SELF, ', (__content_140302383355024 if (__content_140302383355024 is not None) else ''), ', UCMP(nearby_tile_height(0, 0) - ', (__content_140302383355024_1734 if (__content_140302383355024_1734 is not None) else ''), ', ', (__content_140302383355024_1758 if (__content_140302383355024_1758 is not None) else ''), ' - ', (__content_140302383355024_1783 if (__content_140302383355024_1783 is not None) else ''), ')) {\n        0..1: ', (__content_140302383355024_1824 if (__content_140302383355024_1824 is not None) else ''), ';\n        ', (__content_140302383355024_1865 if (__content_140302383355024_1865 is not None) else ''), ';\n    }\n', ))
            if (__content_140302383355024 is None):
                pass
            else:
                if (__content_140302383355024 is False):
    ...
    def render_disallow_coast_or_water(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '\n    switch(FEAT_INDUSTRYTILES, SELF, ${location_check.switch_entry_point}, nearby_tile_is_water(0, 0)) {\n        1: return CB_RESULT_LOCATION_DISALLOW;\n        ${location_check.switch_result};\n    }\n' (41:70)> braces_required=True translation=False at 7f9ab09d1f28> -> __content_140302383355024
            __token = 2083
            __token = 2118
            __content_140302383355024 = _lookup_attr(getitem('location_check'), 'switch_entry_point')
            __content_140302383355024 = __quote(__content_140302383355024, '\x00', '&#0;', None, False)
            __token = 2241
            __content_140302383355024_2239 = _lookup_attr(getitem('location_check'), 'switch_result')
            __content_140302383355024_2239 = __quote(__content_140302383355024_2239, '\x00', '&#0;', None, False)
            __content_140302383355024 = ('%s%s%s%s%s' % ('\n    switch(FEAT_INDUSTRYTILES, SELF, ', (__content_140302383355024 if (__content_140302383355024 is not None) else ''), ', nearby_tile_is_water(0, 0)) {\n        1: return CB_RESULT_LOCATION_DISALLOW;\n        ', (__content_140302383355024_2239 if (__content_140302383355024_2239 is not None) else ''), ';\n    }\n', ))
            if (__content_140302383355024 is None):
                pass
            else:
                if (__content_140302383355024 is False):
    ...
    def render_disallow_steep_slopes(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '\n    switch (FEAT_INDUSTRYTILES, SELF, ${location_check.switch_entry_point}, nearby_tile_slope(0,0) & bitmask(IS_STEEP_SLOPE)) {\n        0: ${location_check.switch_result};\n        return string(STR_ERR_LOCATION_NOT_ON_STEEP_SLOPE);\n    }\n' (50:94)> braces_required=True translation=False at 7f9ab09d1978> -> __content_140302383355024
            __token = 2485
            __token = 2521
            __content_140302383355024 = _lookup_attr(getitem('location_check'), 'switch_entry_point')
            __content_140302383355024 = __quote(__content_140302383355024, '\x00', '&#0;', None, False)
            __token = 2622
            __content_140302383355024_2620 = _lookup_attr(getitem('location_check'), 'switch_result')
            __content_140302383355024_2620 = __quote(__content_140302383355024_2620, '\x00', '&#0;', None, False)
            __content_140302383355024 = ('%s%s%s%s%s' % ('\n    switch (FEAT_INDUSTRYTILES, SELF, ', (__content_140302383355024 if (__content_140302383355024 is not None) else ''), ', nearby_tile_slope(0,0) & bitmask(IS_STEEP_SLOPE)) {\n        0: ', (__content_140302383355024_2620 if (__content_140302383355024_2620 is not None) else ''), ';\n        return string(STR_ERR_LOCATION_NOT_ON_STEEP_SLOPE);\n    }\n', ))
            if (__content_140302383355024 is None):
                pass
            else:
                if (__content_140302383355024 is False):
    ...
    def render_disallow_slopes(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '\n    switch (FEAT_INDUSTRYTILES, SELF, ${location_check.switch_entry_point}, nearby_tile_slope(0,0) == SLOPE_FLAT) {\n        1: ${location_check.switch_result};\n        return CB_RESULT_LOCATION_DISALLOW;\n    }\n' (59:91)> braces_required=True translation=False at 7f9ab09d1278> -> __content_140302383355024
            __token = 2909
            __token = 2945
            __content_140302383355024 = _lookup_attr(getitem('location_check'), 'switch_entry_point')
            __content_140302383355024 = __quote(__content_140302383355024, '\x00', '&#0;', None, False)
            __token = 3034
            __content_140302383355024_3032 = _lookup_attr(getitem('location_check'), 'switch_result')
            __content_140302383355024_3032 = __quote(__content_140302383355024_3032, '\x00', '&#0;', None, False)
            __content_140302383355024 = ('%s%s%s%s%s' % ('\n    switch (FEAT_INDUSTRYTILES, SELF, ', (__content_140302383355024 if (__content_140302383355024 is not None) else ''), ', nearby_tile_slope(0,0) == SLOPE_FLAT) {\n        1: ', (__content_140302383355024_3032 if (__content_140302383355024_3032 is not None) else ''), ';\n        return CB_RESULT_LOCATION_DISALLOW;\n    }\n', ))
            if (__content_140302383355024 is None):
                pass
            else:
                if (__content_140302383355024 is False):
    ...
    def render_require_slope(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '\n    switch(FEAT_INDUSTRYTILES, SELF, ${location_check.switch_entry_point}, nearby_tile_slope(0,0) == SLOPE_FLAT) {\n        1: return CB_RESULT_LOCATION_DISALLOW;\n        ${location_check.switch_result};\n    }\n\n' (68:123)> braces_required=True translation=False at 7f9ab22a70b8> -> __content_140302383355024
            __token = 3327
            __token = 3362
            __content_140302383355024 = _lookup_attr(getitem('location_check'), 'switch_entry_point')
            __content_140302383355024 = __quote(__content_140302383355024, '\x00', '&#0;', None, False)
            __token = 3495
            __content_140302383355024_3493 = _lookup_attr(getitem('location_check'), 'switch_result')
            __content_140302383355024_3493 = __quote(__content_140302383355024_3493, '\x00', '&#0;', None, False)
            __content_140302383355024 = ('%s%s%s%s%s' % ('\n    switch(FEAT_INDUSTRYTILES, SELF, ', (__content_140302383355024 if (__content_140302383355024 is not None) else ''), ', nearby_tile_slope(0,0) == SLOPE_FLAT) {\n        1: return CB_RESULT_LOCATION_DISALLOW;\n        ', (__content_140302383355024_3493 if (__content_140302383355024_3493 is not None) else ''), ';\n    }\n\n', ))
            if (__content_140302383355024 is None):
                pass
            else:
                if (__content_140302383355024 is False):
    ...
    def render_require_road_adjacent(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '\n    switch (FEAT_INDUSTRYTILES, SELF, ${location_check.switch_entry_point},\n                                                      (\n                                                      nearby_tile_class(0, -1) == TILE_CLASS_ROAD ? 1 :\n                                                      (nearby_tile_class(0, 1) == TILE_CLASS_ROAD ? 1 :\n                                                      (nearby_tile_class(-1, 0) == TILE_CLASS_ROAD ? 1 :\n                                                      (nearby_tile_class(1, 0) == TILE_CLASS_ROAD ? 1 : 0\n                                                      ))))) {\n        1: ${location_check.switch_result};\n        return CB_RESULT_LOCATION_DISALLOW;\n    }\n' (78:84)> braces_required=True translation=False at 7f9ab22a7e80> -> __content_140302383355024
            __token = 3720
            __token = 3756
            __content_140302383355024 = _lookup_attr(getitem('location_check'), 'switch_entry_point')
            __content_140302383355024 = __quote(__content_140302383355024, '\x00', '&#0;', None, False)
            __token = 4342
            __content_140302383355024_4340 = _lookup_attr(getitem('location_check'), 'switch_result')
            __content_140302383355024_4340 = __quote(__content_140302383355024_4340, '\x00', '&#0;', None, False)
            __content_140302383355024 = ('%s%s%s%s%s' % ('\n    switch (FEAT_INDUSTRYTILES, SELF, ', (__content_140302383355024 if (__content_140302383355024 is not None) else ''), ',\n                                                      (\n                                                      nearby_tile_class(0, -1) == TILE_CLASS_ROAD ? 1 :\n                                                      (nearby_tile_class(0, 1) == TILE_CLASS_ROAD ? 1 :\n                                                      (nearby_tile_class(-1, 0) == TILE_CLASS_ROAD ? 1 :\n                                                      (nearby_tile_class(1, 0) == TILE_CLASS_ROAD ? 1 : 0\n                                                      ))))) {\n        1: ', (__content_140302383355024_4340 if (__content_140302383355024_4340 is not None) else ''), ';\n        return CB_RESULT_LOCATION_DISALLOW;\n    }\n', ))
            if (__content_140302383355024 is None):
                pass
            else:
                if (__content_140302383355024 is False):
    ...
    def render_require_houses_nearby(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '\n    switch (FEAT_INDUSTRYTILES, SELF, ${location_check.switch_entry_point}, nearby_tile_class(${location_check.x}, ${location_check.y})) {\n        ' (93:86)> braces_required=True translation=False at 7f9ab097c860> -> __content_140302383355024
            __token = 4620
            __token = 4656
            __content_140302383355024 = _lookup_attr(getitem('location_check'), 'switch_entry_point')
            __content_140302383355024 = __quote(__content_140302383355024, '\x00', '&#0;', None, False)
            __token = 4712
            __content_140302383355024_4710 = _lookup_attr(getitem('location_check'), 'x')
            __content_140302383355024_4710 = __quote(__content_140302383355024_4710, '\x00', '&#0;', None, False)
            __token = 4733
            __content_140302383355024_4731 = _lookup_attr(getitem('location_check'), 'y')
            __content_140302383355024_4731 = __quote(__content_140302383355024_4731, '\x00', '&#0;', None, False)
            __content_140302383355024 = ('%s%s%s%s%s%s%s' % ('\n    switch (FEAT_INDUSTRYTILES, SELF, ', (__content_140302383355024 if (__content_140302383355024 is not None) else ''), ', nearby_tile_class(', (__content_140302383355024_4710 if (__content_140302383355024_4710 is not None) else ''), ', ', (__content_140302383355024_4731 if (__content_140302383355024_4731 is not None) else ''), ')) {\n        ', ))
            if (__content_140302383355024 is None):
                pass
            else:
                if (__content_140302383355024 is False):
            ...
            # <Interpolation value=<Substitution '\n        TILE_CLASS_HOUSE: return CB_RESULT_LOCATION_ALLOW;\n        ${location_check.switch_result};\n    }\n' (95:187)> braces_required=True translation=False at 7f9ab0952dd8> -> __content_140302383355024
            __token = 4951
            __token = 5012
            __content_140302383355024 = _lookup_attr(getitem('location_check'), 'switch_result')
            __content_140302383355024 = __quote(__content_140302383355024, '\x00', '&#0;', None, False)
    ...
    def render_allow_player(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '\n    switch (FEAT_INDUSTRYTILES, PARENT, ${location_check.switch_entry_point}, (\n                (((extra_callback_info2 & 0xFF00) >> 8) == IND_CREATION_FUND) ||\n                (((extra_callback_info2 & 0xFF00) >> 8) == IND_CREATION_PROSPECT)\n                )\n            ) {\n        1: return CB_RESULT_LOCATION_ALLOW;\n        ${location_check.switch_result};\n    }\n' (107:7)> braces_required=True translation=False at 7f9ab09525f8> -> __content_140302383355024
            __token = 5403
            __token = 5441
            __content_140302383355024 = _lookup_attr(getitem('location_check'), 'switch_entry_point')
            __content_140302383355024 = __quote(__content_140302383355024, '\x00', '&#0;', None, False)
            __token = 5730
            __content_140302383355024_5728 = _lookup_attr(getitem('location_check'), 'switch_result')
            __content_140302383355024_5728 = __quote(__content_140302383355024_5728, '\x00', '&#0;', None, False)
            __content_140302383355024 = ('%s%s%s%s%s' % ('\n    switch (FEAT_INDUSTRYTILES, PARENT, ', (__content_140302383355024 if (__content_140302383355024 is not None) else ''), ', (\n                (((extra_callback_info2 & 0xFF00) >> 8) == IND_CREATION_FUND) ||\n                (((extra_callback_info2 & 0xFF00) >> 8) == IND_CREATION_PROSPECT)\n                )\n            ) {\n        1: return CB_RESULT_LOCATION_ALLOW;\n        ', (__content_140302383355024_5728 if (__content_140302383355024_5728 is not None) else ''), ';\n    }\n', ))
            if (__content_140302383355024 is None):
                pass
            else:
                if (__content_140302383355024 is False):
    ...
    def render_disallow_industry_adjacent(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '\n    switch(FEAT_INDUSTRYTILES, SELF, ${location_check.switch_entry_point},\n        (nearby_tile_class( 1,  1) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class( 1,  0) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class( 1, -1) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class( 0, -1) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class(-1, -1) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class(-1,  0) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class(-1,  1) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class( 0,  1) == TILE_CLASS_INDUSTRY)) {\n        1: return CB_RESULT_LOCATION_DISALLOW;\n        ${location_check.switch_result};\n    }\n' (124:7)> braces_required=True translation=False at 7f9ab0952438> -> __content_140302383355024
            __token = 6148
            __token = 6183
            __content_140302383355024 = _lookup_attr(getitem('location_check'), 'switch_entry_point')
            __content_140302383355024 = __quote(__content_140302383355024, '\x00', '&#0;', None, False)
            __token = 6765
            __content_140302383355024_6763 = _lookup_attr(getitem('location_check'), 'switch_result')
            __content_140302383355024_6763 = __quote(__content_140302383355024_6763, '\x00', '&#0;', None, False)
            __content_140302383355024 = ('%s%s%s%s%s' % ('\n    switch(FEAT_INDUSTRYTILES, SELF, ', (__content_140302383355024 if (__content_140302383355024 is not None) else ''), ',\n        (nearby_tile_class( 1,  1) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class( 1,  0) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class( 1, -1) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class( 0, -1) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class(-1, -1) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class(-1,  0) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class(-1,  1) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class( 0,  1) == TILE_CLASS_INDUSTRY)) {\n        1: return CB_RESULT_LOCATION_DISALLOW;\n        ', (__content_140302383355024_6763 if (__content_140302383355024_6763 is not None) else ''), ';\n    }\n', ))
            if (__content_140302383355024 is None):
                pass
            else:
                if (__content_140302383355024 is False):
    ...
    def render_disallow_desert(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '\n    switch(FEAT_INDUSTRYTILES, SELF, ${location_check.switch_entry_point},\n                (nearby_tile_terrain_type( 1, -1) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type( 1,  0) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type( 1,  1) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type( 0, -1) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type( 0,  0) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type( 0,  1) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type(-1, -1) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type(-1,  0) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type(-1,  1) == TILETYPE_DESERT)\n            ) {\n        1: return CB_RESULT_LOCATION_DISALLOW;\n        ${location_check.switch_result};\n    }\n' (141:122)> braces_required=True translation=False at 7f9ab0952400> -> __content_140302383355024
            __token = 7028
            __token = 7063
            __content_140302383355024 = _lookup_attr(getitem('location_check'), 'switch_entry_point')
            __content_140302383355024 = __quote(__content_140302383355024, '\x00', '&#0;', None, False)
            __token = 7826
            __content_140302383355024_7824 = _lookup_attr(getitem('location_check'), 'switch_result')
            __content_140302383355024_7824 = __quote(__content_140302383355024_7824, '\x00', '&#0;', None, False)
            __content_140302383355024 = ('%s%s%s%s%s' % ('\n    switch(FEAT_INDUSTRYTILES, SELF, ', (__content_140302383355024 if (__content_140302383355024 is not None) else ''), ',\n                (nearby_tile_terrain_type( 1, -1) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type( 1,  0) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type( 1,  1) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type( 0, -1) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type( 0,  0) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type( 0,  1) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type(-1, -1) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type(-1,  0) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type(-1,  1) == TILETYPE_DESERT)\n            ) {\n        1: return CB_RESULT_LOCATION_DISALLOW;\n        ', (__content_140302383355024_7824 if (__content_140302383355024_7824 is not None) else ''), ';\n    }\n', ))
            if (__content_140302383355024 is None):
                pass
            else:
                if (__content_140302383355024 is False):
    ...
    def render_require_effectively_flat(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '\n    switch (FEAT_INDUSTRYTILES, SELF, ${location_check.switch_entry_point},\n                (\n                nearby_tile_height(-relative_x, -relative_y)\n                + (nearby_tile_slope(-relative_x, -relative_y)\n                == SLOPE_FLAT ? 0 :\n                nearby_tile_slope(-relative_x, -relative_y) == bitmask(IS_STEEP_SLOPE) ? 2 : 1\n                )) == (nearby_tile_height(0, 0)\n                + (nearby_tile_slope(0, 0)\n                == SLOPE_FLAT ? 0 :\n                nearby_tile_slope(0, 0) == bitmask(IS_STEEP_SLOPE) ? 2 : 1))\n                ) {\n        1: ${location_check.switch_result};\n        return CB_RESULT_LOCATION_DISALLOW;\n    }\n' (167:7)> braces_required=True translation=False at 7f9ab0952e80> -> __content_140302383355024
            __token = 8422
            __token = 8458
            __content_140302383355024 = _lookup_attr(getitem('location_check'), 'switch_entry_point')
            __content_140302383355024 = __quote(__content_140302383355024, '\x00', '&#0;', None, False)
            __token = 9004
            __content_140302383355024_9002 = _lookup_attr(getitem('location_check'), 'switch_result')
            __content_140302383355024_9002 = __quote(__content_140302383355024_9002, '\x00', '&#0;', None, False)
            __content_140302383355024 = ('%s%s%s%s%s' % ('\n    switch (FEAT_INDUSTRYTILES, SELF, ', (__content_140302383355024 if (__content_140302383355024 is not None) else ''), ',\n                (\n                nearby_tile_height(-relative_x, -relative_y)\n                + (nearby_tile_slope(-relative_x, -relative_y)\n                == SLOPE_FLAT ? 0 :\n                nearby_tile_slope(-relative_x, -relative_y) == bitmask(IS_STEEP_SLOPE) ? 2 : 1\n                )) == (nearby_tile_height(0, 0)\n                + (nearby_tile_slope(0, 0)\n                == SLOPE_FLAT ? 0 :\n                nearby_tile_slope(0, 0) == bitmask(IS_STEEP_SLOPE) ? 2 : 1))\n                ) {\n        1: ', (__content_140302383355024_9002 if (__content_140302383355024_9002 is not None) else ''), ';\n        return CB_RESULT_LOCATION_DISALLOW;\n    }\n', ))
            if (__content_140302383355024 is None):
                pass
            else:
                if (__content_140302383355024 is False):
