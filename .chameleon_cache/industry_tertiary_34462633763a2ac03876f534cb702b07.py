...
_static_139703103864504 = 'load: properties_industry.pynml'
_static_139703103863776 = "location_checks_industry.macros['render_tree']"
_static_139703103862600 = 'load: availability.pynml'
_static_139703103862712 = 'load: layouts.pynml'
_static_139703104130744 = 'load: properties_tile.pynml'
_static_139703104129344 = "animation_macros.macros['tile_animation']"
_static_139703104128168 = "location_checks_tile.macros['render_tree']"
_static_139703104130072 = 'load: graphics_switches.pynml'
_static_139703104127664 = 'load: spritelayouts.pynml'
_static_139703104131024 = 'load: spritesets.pynml'
...
def initialize(__loader, macros, nothing, template):
    ...
    def render(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            __append('\n\n')
            __backup_location_checks_tile_139703104331672 = get('location_checks_tile', __marker)
            ...
            if (__backup_location_checks_tile_139703104331672 is __marker):
                ...
                econtext['location_checks_tile'] = __backup_location_checks_tile_139703104331672
            __append('\n\n')
            __backup_animation_macros_139703103358120 = get('animation_macros', __marker)
            ...
            if (__backup_animation_macros_139703103358120 is __marker):
                ...
                econtext['animation_macros'] = __backup_animation_macros_139703103358120
            __append('\n\n')
            ...
            __append('\n\n')
            __backup_location_checks_industry_139703105755904 = get('location_checks_industry', __marker)
            ...
            if (__backup_location_checks_industry_139703105755904 is __marker):
                ...
                econtext['location_checks_industry'] = __backup_location_checks_industry_139703105755904
            __append('\n\n')
            ...
            (__iterator, ____index_139703103864672, ) = getitem('repeat')('economy', __iterator)
            ...
            for __item in __iterator:
                ...
                if __condition:
                    ...
                    __token = 1589
                    __content_139703124559104_1587 = _lookup_attr(getitem('industry'), 'id')
                    __content_139703124559104_1587 = __quote(__content_139703124559104_1587, '\x00', '&#0;', None, False)
                    __token = 1605
                    __content_139703124559104_1603 = _lookup_attr(getitem('industry'), 'numeric_id')
                    __content_139703124559104_1603 = __quote(__content_139703124559104_1603, '\x00', '&#0;', None, False)
                    __token = 1704
                    __content_139703124559104_1702 = _lookup_attr(getitem('industry'), 'id')
                    __content_139703124559104_1702 = __quote(__content_139703124559104_1702, '\x00', '&#0;', None, False)
                    __token = 1870
                    __content_139703124559104_1868 = _lookup_attr(getitem('industry'), 'id')
                    __content_139703124559104_1868 = __quote(__content_139703124559104_1868, '\x00', '&#0;', None, False)
                    __token = 1947
                    __content_139703124559104_1945 = _lookup_attr(getitem('industry'), 'get_extra_text_fund')(getitem('economy'))
                    __content_139703124559104_1945 = __quote(__content_139703124559104_1945, '\x00', '&#0;', None, False)
                    __content_139703124559104 = ('%s%s%s%s%s%s%s%s%s%s%s%s%s' % ('\n        if (economy==', (__content_139703124559104 if (__content_139703124559104 is not None) else ''), ') {\n            item(FEAT_INDUSTRIES, ', (__content_139703124559104_1587 if (__content_139703124559104_1587 is not None) else ''), ', ', (__content_139703124559104_1603 if (__content_139703124559104_1603 is not None) else ''), ') {\n                graphics {\n                    construction_probability: ', (__content_139703124559104_1702 if (__content_139703124559104_1702 is not None) else ''), '_check_availability;\n                    build_prod_change:        randomise_primary_production_on_build;\n                    location_check:           ', (__content_139703124559104_1868 if (__content_139703124559104_1868 is not None) else ''), '_check_location;\n                    extra_text_fund:          ', (__content_139703124559104_1945 if (__content_139703124559104_1945 is not None) else ''), ';\n                    colour:                   switch_colour;\n                }\n            }\n        }\n    ', ))
