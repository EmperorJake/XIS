...
def initialize(__loader, macros, nothing, template):
    ...
    def render(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            __content_140383655711776 = ('%s%s%s' % ('\nswitch(FEAT_INDUSTRIES, SELF, ', (__content_140383655711776 if (__content_140383655711776 is not None) else ''), '_check_availability_param, restrict_open_during_gameplay) {\n\t1..255: return CB_RESULT_IND_NO_CONSTRUCTION;         // disallow when restrictions in place\n\treturn CB_RESULT_IND_PROBABILITY_FROM_PROPERTY;       // we may build\n}\n\n', ))
            ...
            __content_140383655711776 = __quote(__content_140383655711776, '\x00', '&#0;', None, False)
            __token = 759
            __content_140383655711776_757 = _lookup_attr(getitem('industry'), 'id')
            __content_140383655711776_757 = __quote(__content_140383655711776_757, '\x00', '&#0;', None, False)
            __content_140383655711776 = ('%s%s%s%s%s' % ('\nswitch (FEAT_INDUSTRIES, SELF, ', (__content_140383655711776 if (__content_140383655711776 is not None) else ''), '_check_map_gen, extra_callback_info2 == IND_CREATION_GENERATION) {\n\t1: return CB_RESULT_IND_PROBABILITY_FROM_PROPERTY;\n\t', (__content_140383655711776_757 if (__content_140383655711776_757 is not None) else ''), '_check_availability_param;\n}\n', ))
            if (__content_140383655711776 is None):
                pass
            else:
                if (__content_140383655711776 is False):
            ...
            __content_140383655711776 = __quote(__content_140383655711776, '\x00', '&#0;', None, False)
            __token = 949
            __content_140383655711776_947 = _lookup_attr(getitem('industry'), 'id')
            __content_140383655711776_947 = __quote(__content_140383655711776_947, '\x00', '&#0;', None, False)
            __content_140383655711776 = ('%s%s%s%s%s' % ('\nswitch (FEAT_INDUSTRIES, SELF, ', (__content_140383655711776 if (__content_140383655711776 is not None) else ''), '_available_game_mode, game_mode == GAMEMODE_GAME) {\n\t1: ', (__content_140383655711776_947 if (__content_140383655711776_947 is not None) else ''), '_check_map_gen;\n\treturn CB_RESULT_IND_PROBABILITY_FROM_PROPERTY;\n}\n\n', ))
            if (__content_140383655711776 is None):
                pass
            else:
                if (__content_140383655711776 is False):
            ...
            (__iterator, ____index_140383635785936, ) = getitem('repeat')('economy', __iterator)
            ...
            for __item in __iterator:
                ...
                __token = 1153
                __token = 1158
                __content_140383655711776 = _lookup_attr(getitem('industry'), 'get_intro_year')(getitem('economy'))
                __content_140383655711776 = __quote(__content_140383655711776, '\x00', '&#0;', None, False)
                __token = 1232
                __content_140383655711776_1230 = _lookup_attr(getitem('industry'), 'id')
                __content_140383655711776_1230 = __quote(__content_140383655711776_1230, '\x00', '&#0;', None, False)
                __token = 1266
                __content_140383655711776_1264 = _lookup_attr(getitem('economy'), 'numeric_id')
                __content_140383655711776_1264 = __quote(__content_140383655711776_1264, '\x00', '&#0;', None, False)
                __token = 1318
                __content_140383655711776_1316 = _lookup_attr(getitem('industry'), 'get_intro_year')(getitem('economy'))
                __content_140383655711776_1316 = __quote(__content_140383655711776_1316, '\x00', '&#0;', None, False)
                __token = 1367
                __content_140383655711776_1365 = _lookup_attr(getitem('industry'), 'get_expiry_year')(getitem('economy'))
                __content_140383655711776_1365 = __quote(__content_140383655711776_1365, '\x00', '&#0;', None, False)
                __token = 1412
                __content_140383655711776_1410 = _lookup_attr(getitem('industry'), 'id')
                __content_140383655711776_1410 = __quote(__content_140383655711776_1410, '\x00', '&#0;', None, False)
                __content_140383655711776 = ('%s%s%s%s%s%s%s%s%s%s%s%s%s' % ('\n    /* ', (__content_140383655711776 if (__content_140383655711776 is not None) else ''), ' */\n    switch (FEAT_INDUSTRIES, SELF, ', (__content_140383655711776_1230 if (__content_140383655711776_1230 is not None) else ''), '_check_availability_', (__content_140383655711776_1264 if (__content_140383655711776_1264 is not None) else ''), ', current_date) {\n        date(', (__content_140383655711776_1316 if (__content_140383655711776_1316 is not None) else ''), ',1,1) .. date(', (__content_140383655711776_1365 if (__content_140383655711776_1365 is not None) else ''), ',12,31): ', (__content_140383655711776_1410 if (__content_140383655711776_1410 is not None) else ''), '_available_game_mode;\n        return CB_RESULT_IND_NO_CONSTRUCTION;\n    }\n', ))
                if (__content_140383655711776 is None):
                    pass
                else:
                    if (__content_140383655711776 is False):
            ...
            __content_140383655711776 = _lookup_attr(getitem('industry'), 'id')
            __content_140383655711776 = __quote(__content_140383655711776, '\x00', '&#0;', None, False)
            __content_140383655711776 = ('%s%s%s' % ('\n\nswitch (FEAT_INDUSTRIES, SELF, ', (__content_140383655711776 if (__content_140383655711776 is not None) else ''), '_check_availability, economy) {\n    ', ))
            if (__content_140383655711776 is None):
                pass
            else:
                if (__content_140383655711776 is False):
            ...
            __token = 1639
            __iterator = getitem('economies')
            (__iterator, ____index_140383635784480, ) = getitem('repeat')('economy', __iterator)
            econtext['economy'] = None
            for __item in __iterator:
                econtext['economy'] = __item
                ...
                __content_140383655711776 = __quote(__content_140383655711776, '\x00', '&#0;', None, False)
                __token = 1684
                __content_140383655711776_1682 = _lookup_attr(getitem('industry'), 'id')
                __content_140383655711776_1682 = __quote(__content_140383655711776_1682, '\x00', '&#0;', None, False)
                __token = 1718
                __content_140383655711776_1716 = _lookup_attr(getitem('economy'), 'numeric_id')
                __content_140383655711776_1716 = __quote(__content_140383655711776_1716, '\x00', '&#0;', None, False)
                __content_140383655711776 = ('%s%s%s%s%s%s%s' % ('\n        ', (__content_140383655711776 if (__content_140383655711776 is not None) else ''), ': ', (__content_140383655711776_1682 if (__content_140383655711776_1682 is not None) else ''), '_check_availability_', (__content_140383655711776_1716 if (__content_140383655711776_1716 is not None) else ''), ';\n    ', ))
                if (__content_140383655711776 is None):
                    pass
                else:
                    if (__content_140383655711776 is False):
